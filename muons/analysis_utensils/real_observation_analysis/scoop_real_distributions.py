...
Usage: scoop_real_distributions.py --muon_dir=DIR --output_dir=DIR --epochFile=PTH --scoop_hosts=PTH
...
def main(muon_dir, output_dir, scoop_hosts, epochFile):
    Analysis = roa.RealObservationAnalysis(
        muon_dir, output_dir, epochFile, scoop_hosts)
...
if __name__=='__main__':
    try:
        ...
        main(muon_dir, output_dir, scoop_hosts, epochFile)
